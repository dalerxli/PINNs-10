...
if __name__ == "__main__": 
    ...
    # Setting
    N_u = 157   # when data is vowel.mat
    #N_u = 100   # When data is formant.mat
    ...
    #data = scipy.io.loadmat('Data/MATLAB/formant.mat')
    ...
    ax.plot(t[7]*np.ones((2,1)), line, 'w-', linewidth = 1)    
    ...
    ax.plot(x,Exact[7,:], 'b-', linewidth = 2, label = 'Exact')       
    ax.plot(x,U_pred[7,:], 'r--', linewidth = 2, label = 'Prediction')
    ax.set_xlabel('$x$')
    ax.set_ylabel('$u(t,x)$')
    ax.axis('square')
    ax.set_xlim([-1.1,1.1])
